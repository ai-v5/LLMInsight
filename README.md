...
到 [**Releases**](https://github.com/ai-v5/LLMInsight/releases/latest) 下载 `llminsight-0.2.0-py3-none-any.whl`，安装即可运行（whl 已内置 Web 前端与芯片配置，离线可用，无需克隆仓库）：

```bash
pip install llminsight-0.2.0-py3-none-any.whl   # 自动装好 pandas / numpy / pyyaml
